...
const Modal: FC<pageProps> = ({
    ...
    return (
        <>
            {/* Modal */}
            <div
                className={`modal z-[1] fixed w-full h-full top-0 left-0 flex items-center justify-center ${isOpen ? "" : "hidden"}`}>
                <div className="modal-overlay absolute w-full h-full bg-gray-900 opacity-50" onClick={toggleModal}/>

                <div
                    className="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-[1] overflow-y-auto">
                    ...
                    <div className="modal-content py-4 text-left px-6">
                        ...
                        <div className="modal-header text-lg font-semibold relative">
                            {title}
                            <div className="modal-close cursor-pointer flex justify-end absolute right-0 top-0"
                                 onClick={toggleModal}>
